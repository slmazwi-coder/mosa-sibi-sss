      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
            <h2 className="text-2xl font-bold text-[#6B2D15] mb-8">Get in Touch</h2>
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#FDF5E6] text-[#6B2D15] rounded-xl">
                  <MapPin size={24} />
                </div>
                <div>
          ...
          >
            <h2 className="text-2xl font-bold text-[#6B2D15] mb-8">Send us a Message</h2>
