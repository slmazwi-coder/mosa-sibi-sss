      ...
      <div className="py-20 flex items-center justify-center min-h-[60vh]">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            Thank you for applying to Mosa Sibi Senior Secondary School. We have received your application and will be in contact shortly.
          </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
              <div>
                ...
                <p className="text-white/70 text-sm mt-1">
                  Mosa Sibi Senior Secondary School &nbsp;·&nbsp; Igoga Location, Matatiele 4730
                </p>
              </div>
